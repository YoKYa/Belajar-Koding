<template>
     ...
     <div v-if="!load" class="flex flex-col items-center my-8">
          <div class="flex items-center justify-center w-5/6 overflow-hidden shadow-md  bg-gray-50 h-28 rounded-t-xl">
               <img src="@/assets/img/profile/banner.png" alt="" srcset="" />
          </div>
          <div class="flex flex-col w-5/6 pt-8 pl-8 bg-white border-t-2 border-blue-400 shadow-md  h-96 rounded-b-xl">
               <div
                    ...
                    <div v-if="picture.length == 1" class="text-6xl">
                         <router-link to="/app/profile/picture"
                    ...
                    <img :src="picture" v-else class="rounded-full" alt="profile" />
               </div>
               <div class="flex">
                    <Menu />
                    <div class="flex flex-col mx-2 mt-12 ml-16 text-lg font-semibold transform  w-92">
                         <label
