<template>
               ...
               <div class="w-full h-full overflow-auto shadow" id="journal-scroll">
                    <div class="flex m-2">
                         <div class="flex flex-col w-1/5 m-2 text-xs">
                              <div class="flex items-center justify-center h-48 mb-2 rounded-lg ">
                                   <div v-if="data.loadData">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             ...
                                             <circle cx="50" cy="50" r="0" fill="none" stroke="#88e1f2"
                                                  stroke-width="11">
                                                  <animate attributeName="r" repeatCount="indefinite"
                                                       dur="1.7543859649122806s" values="0;24" keyTimes="0;1"
                                   ...
                                   <div class="flex items-center justify-center w-full h-full " v-else>
                                        <img :src="data.language.picture" class="h-28 rounded-2xl" />
                                   </div>
                              </div>
                              <div class="relative bg-white border-2 border-gray-200 rounded-lg shadow-lg h-96">
                                   <div class="w-full">
                                        <div class="flex p-1 mx-2 my-2 bg-white border border-gray-200 rounded ">
                                             <div class="flex flex-wrap flex-auto "></div>
                                             <input placeholder="Search" v-model="form.search" @change="search()"
                                             ...
                                             <div
                                                  ...
                                                  <button @click="search"
                                                       ...
                                                       <svg xmlns="http://www.w3.org/2000/svg" width="100%"
                                                            ...
                                                            class="w-4 h-4 feather feather-chevron-up">
                                   ...
                                   <div class="absolute left-0 z-40 w-full h-64 overflow-y-auto bg-white rounded shadow top-100 max-h-select svelte-5uyqqj"
                                        id="journal-scroll">
                                        <div class="flex flex-col w-full">
                                             ...
                                             <div
                                                  ...
                                                  <div v-if="data.loadKelas">
                                                       <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <circle cx="50" cy="50" r="0" fill="none" stroke="#88e1f2"
                                                                 stroke-width="11">
                                                                 <animate attributeName="r" repeatCount="indefinite"
                                                                      dur="1.7543859649122806s" values="0;24"
                                                                      keyTimes="0;1" keySplines="0 0.2 0.8 1"
                                                                      calcMode="spline" begin="0s" />
                                                                 <animate attributeName="opacity"
                                                                      repeatCount="indefinite" dur="1.7543859649122806s"
                                                            ...
                                                            <circle cx="50" cy="50" r="0" fill="none" stroke="#88e1f2"
                                                                 ...
                                                                 <animate attributeName="r" repeatCount="indefinite"
                                                                      dur="1.7543859649122806s" values="0;24"
                                                                      keyTimes="0;1" keySplines="0 0.2 0.8 1"
                                                                      calcMode="spline" begin="-0.8771929824561403s" />
                                                                 <animate attributeName="opacity"
                                                                      repeatCount="indefinite" dur="1.7543859649122806s"
                                                                      values="1;0" keyTimes="0;1"
                                                                      keySplines="0.2 0 0.8 1" calcMode="spline"
                                                  ...
                                                  <div v-for="study in data.kelas" :key="study.id" v-else
                                   ...
                                   <div class="absolute left-0 w-full bottom-1">
                                        <div class="flex flex-col w-full p-2 py-4 ">
                                             <button @click="add"
                         ...
                         <div class="flex flex-col w-4/5 m-2">
                              <div
                                   ...
                                   <router-link to="/app/admin/materi"
                                        ...
                                        <div v-else>
                                             <div class="flex mx-3 mb-4">
                                                  <div class="flex flex-col w-4/12">
                                                       <div class="flex justify-center my-2">
                                                            <div class="flex flex-col w-48 border-2 h-52">
                                                                 <div class="flex justify-center max-h-44"> <img
                                                                           :src="img" /></div>
                                                                 <div class="flex">
                                                                      <label
                                                                           class="w-full bg-transparent bg-gray-600 bottom-4 ">
                                                                           <span
                                                                                class="mx-2 mt-2 text-base leading-normal text-white">
                                                                                Select a Image
                                                                           </span>
                                                  ...
                                                  <div class="flex flex-col w-8/12">
                                                       ...
                                                       <textarea rows="5"
                                                            class="flex w-full p-2 border-2 border-gray-200 rounded-md focus:outline-none focus:border focus:border-blue-500"
                                                            v-model="form.description"> </textarea>
                                                       <button
                                                            class="p-1 my-2 text-sm text-white bg-blue-700 rounded-lg w-28 focus:outline-none hover:bg-blue-400"
                                                            @click="editDesc">Simpan</button>
                                                  </div>
                                             </div>
                                             <hr>
                                             <div class="flex flex-col pt-2">
                                                  <div class="flex justify-end mx-4 my-2">
                                                       <button
                                                            class="py-2 text-sm font-semibold text-blue-400 duration-200 transform bg-white border-2 border-white rounded-lg w-36 hover:border-blue-500 hover:text-blue-500 animate-fade-in"
                                                            @click="toggle.bagian = true">Tambah bagian</button>
                                                  </div>
                                                  <div class="flex flex-col mx-4 my-2" v-if="toggle.bagian">
                                                       <label class="my-1 text-sm font-semibold">Tambah Bagian</label>
                                                       <input type="text"
                                                            class="p-2 border-2 border-gray-200 rounded-md focus:outline-none focus:border focus:border-blue-500"
                                                            v-model="formBagian.name">
                                                       <div>
                                                            <button
                                                                 class="p-1 my-2 text-sm text-white bg-blue-700 rounded-lg w-28 focus:outline-none hover:bg-blue-400"
                                                                 @click="createBagian">Tambah</button>
                                                            <button
                                                                 class="p-1 mx-2 my-2 text-sm text-white bg-red-700 rounded-lg w-28 focus:outline-none hover:bg-red-400"
                                                                 @click="toggle.bagian = false">Batal</button>
                                                       </div>
                                                  </div>
                                                  <div
                                                       class="flex flex-col mx-4 my-2 border-2 border-gray-200 rounded-lg">
                                                       <div class="my-4 font-semibold text-center ">DAFTAR PELAJARAN
                                                       </div>
                                                       <hr>
                                                       <div class="p-3 m-2 border-2 border-gray-200 rounded-lg"
                                                            v-for="bagian in data.bagian" :key="bagian.id">
                                                            <div class="flex justify-between">
                                                                 <div class="py-2 ml-4 font-semibold uppercase ">#{{
                                                                           bagian.id
                                                                 }} {{ bagian.name }}</div>
                                                                 <div class="p-1 my-1 ml-4 text-blue-500 bg-white border-2 border-blue-500 rounded-lg cursor-pointer hover:bg-blue-500 hover:text-white"
                                                                      @click="toggle.topic = bagian.id">
                                                                      <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <div class="flex flex-col">
                                                                 <div>
                                                                      <router-link :to="'/app/admin/m/' + topics.code"
                                                                           v-for="topics in bagian.topics"
                                                                           :key="topics.id">
                                                                           <div
                                                                                class="py-2 mx-10 cursor-pointer hover:bg-gray-100">
                                                                 ...
                                                                 <div>
                                                                      <div class="flex flex-col mx-4 my-2"
                                                                           v-if="toggle.topic == bagian.id">
                                                                           <label
                                                                                class="my-1 text-sm font-semibold">Tambah
                                                                                Topik Pembahasan</label>
                                                                           <input type="text"
                                                                                class="p-2 border-2 border-gray-200 rounded-md focus:outline-none focus:border focus:border-blue-500"
                                                                           ...
                                                                           <div>
                                                                                <button
                                                                                     class="p-1 my-2 text-sm text-white bg-blue-700 rounded-lg w-28 focus:outline-none hover:bg-blue-400"
                                                                                     @click="createTopic(bagian.id)">Tambah</button>
                                                                                <button
                                                                                     class="p-1 mx-2 my-2 text-sm text-white bg-red-700 rounded-lg w-28 focus:outline-none hover:bg-red-400"
                                                                                     @click="toggle.topic = false">Batal</button>
                                                                           </div>
                                                                      </div>
                                                                 </div>
                                                            </div>
                                                            <div class="flex justify-end">
                                                                 <button
                                                                      class="p-1 my-2 text-sm text-white bg-red-700 rounded-lg w-28 focus:outline-none hover:bg-red-400"
                                                                      @click="delBagian(bagian.id)">Hapus
                                                                      Bagian</button>
                                                            </div>
                                                       </div>
                                                  </div>
                                             ...
                                             <div class="flex justify-end mx-4 my-2">
                                                  <button
                                                       class="py-2 text-sm font-semibold text-red-400 duration-200 transform bg-white border-2 border-white rounded-lg w-36 hover:border-red-500 hover:text-red-500 animate-fade-in"
                                                       @click="toggle.delMateri = true">Hapus Materi</button>
                                             </div>
                                        </div>
                                   </div>
               ...
               <div class="px-4 pt-5 pb-4 bg-white rounded-md sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                         ...
                         <div class="mt-3 text-center rounded-md sm:mt-0 sm:ml-4 sm:text-left">
                              ...
                              <div class="mt-2 text-xs text-red-500" v-for="error in errors.name" :key="error.id">
                                   {{ error }}
                              </div>
                         </div>
                    </div>
               </div>
               <div class="px-4 py-3 rounded-bS-md bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button @click="addKelas" type="button"
     ...
     <Modal v-if="toggle.delMateri">
          <div>
               ...
               <div class="px-4 py-3 rounded-bS-md bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button @click="delKelas" type="button"
                         class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                         Hapus
                    </button>
                    <button @click="toggle.delMateri = false" type="button"
                         class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                         Batal
                    </button>
               </div>
               ...
               <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="
				...
				" width="80px" height="80px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <circle cx="50" cy="50" r="0" fill="none" stroke="#88e1f2" stroke-width="11">
                         <animate attributeName="r" repeatCount="indefinite" dur="1.7543859649122806s" values="0;24"
                              keyTimes="0;1" keySplines="0 0.2 0.8 1" calcMode="spline" begin="0s" />
                    ...
                    <circle cx="50" cy="50" r="0" fill="none" stroke="#88e1f2" stroke-width="11">
                         <animate attributeName="r" repeatCount="indefinite" dur="1.7543859649122806s" values="0;24"
                              keyTimes="0;1" keySplines="0 0.2 0.8 1" calcMode="spline" begin="-0.8771929824561403s" />
                         <animate attributeName="opacity" repeatCount="indefinite" dur="1.7543859649122806s"
